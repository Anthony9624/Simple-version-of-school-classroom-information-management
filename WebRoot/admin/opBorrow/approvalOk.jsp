...
<%
	...
	String strUpdate = "update Borrow set usestatus='T' ";
            ...
            <tr><td>
            	...
            	<tr><td>
	            	<font size=4>
          			...
          			<center><br>
				   	<input type="button" value="返回" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opBorrow/approvalBorrows')" style="width:125px;height:30px"/>
				   	</center>
            	</td></tr>
            	</table>
            	</center>
