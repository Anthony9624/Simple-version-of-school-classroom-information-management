        ...
        <tr><td align="center">
            ...
            <tr><td>
            	...
            	<font size=6>增加教师</font>
            		...
            		<tr><td>
            			<form id="addTeacher" name="addTeacherForm" method="post" action="<%=basePath%>admin/index.jsp?mainPage=opTeacher/addTeacherOk" onsubmit="checkFrom(this);">
	            			...
	            			<br>职称:<input type="text" name="titleType" size=17/>
