            ...
            <tr><td>
            	...
            	<font size=4>
           	     ...
           	     职&nbsp;称&nbsp;:<%=strTitle%><br>
          			...
          			<center>
				   	<input type="button" value="继续添加" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opTeacher/addTeacher')" style="width:125px;height:30px"/>
				   	<input type="button" value="查看教师" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opTeacher/lookTeachers&id=1')" style="width:125px;height:30px"/>
				   	</center>
            	</td></tr>
            	</table>
            	</center>
