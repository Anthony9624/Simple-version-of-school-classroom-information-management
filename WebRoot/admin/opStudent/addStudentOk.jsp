            ...
            <tr><td>
            	...
            	<font size=4>
           	    <P>&nbsp;&nbsp;学&nbsp;号&nbsp;:<%=studentNum%><br>
          			...
          			<center>
				   	<input type="button" value="继续添加" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opStudent/addStudent')" style="width:125px;height:30px"/>
				   	<input type="button" value="查看学生信息" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opStudent/lookStudents&id=1')" style="width:125px;height:30px"/>
				   	</center>
            	</td></tr>
            	</table>
            	</center>
            	...
            	<tr><td>
            		...
            		<% 
          			...
          			<br><br><br>
				   	<input type="button" value="重新添加" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opStudent/addStudent')" style="width:125px;height:30px"/>
