        ...
        <tr><td align="center">
            ...
            <tr><td>
            	...
            	<font size=6>增加开课信息</font>
            		...
            		<tr><td>
            			<form id="addSchedule" name="addScheduleForm" method="post" action="<%=basePath%>admin/index.jsp?mainPage=opSchedule/addScheduleOk" onsubmit="checkFrom(this);">
	            			...
	            			<center>
						   	<input type="submit" value="添加" name="submit" style="width:120px;height:30px"/>
						   	<input type="button" value="取消并返回" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opSchedule/lookSchedules&id=1')" style="width:120px;height:30px"/>
						   	</center>
	            		</form>
            		</td></tr>
            		</table>
