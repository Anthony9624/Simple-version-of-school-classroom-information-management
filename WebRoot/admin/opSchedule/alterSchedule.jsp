    ...
    <center>
        ...
        <tr><td align="center">
            ...
            <tr><td>
            	...
            	<tr><td>
            		<form id="alterSchedule" name="alterScheduleForm" method="post" action="<%=basePath%>admin/index.jsp?mainPage=opSchedule/alterScheduleOk" onsubmit="checkFrom(this);">
						...
						<center>
						   	<input type="submit" value="保存" name="submit" style="width:100px;height:30px"/>
						   	<input type="button" value="取消并返回" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opSchedule/lookSchedules')" style="width:100px;height:30px"/>
						</center>
            		</form>
            	</td></tr>
            	</table>
