...
<jsp:useBean id="scheduleInfo" class="com.Group4.opdb.CmSysDBInfo" scope="page"></jsp:useBean>
            ...
            <tr><td>
            	...
            	<center>
	            	...
	            	<font size=4>
         			...
         			<center>
			   		<input type="button" value="继续添加" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opSchedule/addSchedule')" style="width:125px;height:30px"/>
			   		<input type="button" value="查看开课信息" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opSchedule/lookSchedules&id=1')" style="width:125px;height:30px"/>
			   	</center>
            	</td></tr>
            	</table>
            	</center>
            	...
            	<tr><td>
            		...
            		<% 
          			...
          			<br><br><br>
				   	<input type="button" value="重新添加" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opSchedule/addSchedule')" style="width:125px;height:30px"/>
				   	<input type="button" value="返回后台首页" onclick="window.location.href('<%=basePath%>admin/index.jsp')" style="width:125px;height:30px"/>
				   	</center>
            	</td></tr>
            	</table>
            	</center>
