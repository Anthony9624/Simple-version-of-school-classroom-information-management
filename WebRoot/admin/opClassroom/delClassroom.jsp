            	...
            	<tr><td>
            		<form id="delClassroom" name="delClassroomForm" method="post" action="<%=basePath%>admin/index.jsp?mainPage=opClassroom/delClassroomOk&clno=<%=strCno%>">
            			<center>
							...
							<input type="submit" value="确认删除" name="submit" style="width:100px;height:30px"/>
							<input type="button" value="取消并返回" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opClassroom/lookClassrooms')" style="width:100px;height:30px"/>
						</center>
            		</form>
            	</td></tr>
            	</table>
