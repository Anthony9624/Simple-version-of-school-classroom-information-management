        ...
        <tr><td align="center">
            ...
            <tr><td>
            	...
            	<font size=6>增加教室信息</font>
            		...
            		<tr><td>
            			<form id="addClassroom" name="addClassroomForm" method="post" action="<%=basePath%>admin/index.jsp?mainPage=opClassroom/addClassroomOk" onsubmit="checkFrom(this);">
	            			<P> <br>教室编号:
	            			<input type="text" name="classroomNum" size=17/>
	            			<br>容纳人数:
	            			<input type="text" name="holdNum" size=17/><br>
						   	...
						   	<center>
						   	<input type="submit" value="添加" name="submit" style="width:100px;height:30px"/>
						   	<input type="button" value="取消并返回" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opClassroom/lookClassrooms&id=1')" style="width:100px;height:30px"/>
						   	</center>
	            		</form>
            		</td></tr>
            		</table>
