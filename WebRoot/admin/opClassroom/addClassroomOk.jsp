            ...
            <tr><td>
            	...
            	<font size=4>
           	     ...
           	     设&nbsp;备&nbsp;:<%=deviceType%><br><br>
          			...
          			<center>
				   	<input type="button" value="继续添加" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opClassroom/addClassroom')" style="width:125px;height:30px"/>
				   	<input type="button" value="查看教室信息" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opClassroom/lookClassrooms&id=1')" style="width:125px;height:30px"/>
				   	</center>
            	</td></tr>
            	</table>
            	</center>
            	...
            	<tr><td>
            		...
            		<% 
          			...
          			<br><br><br>
				   	<input type="button" value="重新添加" onclick="window.location.href('<%=basePath%>admin/index.jsp?mainPage=opClassroom/addClassroom')" style="width:125px;height:30px"/>
