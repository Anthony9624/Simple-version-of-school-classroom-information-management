				...
				<TBODY>
					...
					<TR>
						<TD width=246 background="img/denglu0.jpg" height=301>
							...
							<form name="form" method="POST" action="login.jsp" onSubmit="checkform()">
						...
						<TD vAlign=top width=503>
							<TABLE id=table2 cellSpacing=0 cellPadding=0 width="100%"
								...
								<TBODY>
									<TR>
										<TD>
											<IMG height=224 src="img/2.png" width=503 border=0>
										</TD>
									</TR>
									<TR>
										<TD height=13></TD>
									...
									<TR>
										<TD>
											<P align=center>
												<IMG height=56 src="img/3.jpg" width=372 border=0>
											</P>
										</TD>
									</TR>
								</TBODY>
					...
					<TR>
						<TD colSpan=3>
							<IMG height=5 src="img/line.jpg" width=757 border=0>
						</TD>
					</TR>
					<TR>
						<TD height=15></TD>
